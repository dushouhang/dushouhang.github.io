...
2. **Du, S.**, Zhang, Y., Zhu, L., Wang, S., Liu, Z., Zhou, H., Zhang, X., & Du, S. (2025). A Multimodal Data Fusion Framework for Urban Functional ZoneMapping Based on Local-Global Information Enhancement andAdaptive Spatial Units: From Standard Datasets to Global CityValidation. _International Journal of Applied Earth Observation and Geoinformation_.(SCI, IF= 8.6, JCR一区, 中科院一区TOP)
